<div  class="modal fade quickview in quickview-modal-product-details-{{$product -> id}}" tabindex="-1" role="dialog" style="display: hidden;">
                    ...
                    <div class="col-md-5 col-sm-5 divide-right">
                        <div class="images-container bottom_thumb">
                            <div class="product-cover">
                                <img class="js-qv-product-cover img-fluid" src="{{image_path('products', ($product -> images[0] -> photo ?? ''))}}" alt="" title="" style="width:100%;" itemprop="image">
