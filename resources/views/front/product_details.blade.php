...
@section('content')
                ...
                <section id="main" itemscope="" itemtype="https://schema.org/Product">
                                                        ...
                                                        @foreach($product -> images as $image)
                                                            <div class="item thumb-container col-md-6 col-xs-12 pt-30">
                                                                <img class="img-fluid thumb js-thumb  selected "
                                                                     data-image-medium-src="{{image_path('products',$image -> photo)}}"
                                                                     data-image-large-src="{{image_path('products',$image -> photo)}}"
                                                                     src="{{image_path('products',$image -> photo)}}"
					...
					<div class="product-detail-bottom"> 
                        <div class="container">
                            ...
                            <section class="relate-product product-accessories clearfix mb-10 mt-10">
                                ...
                                <div class="products product_list grid owl-theme" data-autoplay="true"
    ...
    @include('front.includes.not_logged_modal')
@stop
