                ...
                <ol itemscope="" itemtype="http://schema.org/BreadcrumbList">
                    ...
                    <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                        <a itemprop="item" href="36-mini-speaker.html">
                            <span itemprop="name">Your WishList</span>
                        </a>
                                ...
                                <div class="products product_list grid row" data-default-view="grid">
                                    @isset($products)
                                        @foreach($products as $product)
                                                        ...
                                                        <a href="{{route('product.details',$product -> slug)}}"
                                                           class="thumbnail product-thumbnail two-image">
                                                            <img class="img-fluid image-cover"
                                                                 src="{{image_path('products', ($product -> images[0] -> photo ?? ''))}}"
                                                                 alt=""
                                                                 data-full-size-image-url="{{image_path('products', ($product -> images[0] -> photo ?? ''))}}"
                                           ...
                                           @include('front/includes/product_details',$product)
                                        @endforeach
                                    @endisset
                                </div>
                            </div>
